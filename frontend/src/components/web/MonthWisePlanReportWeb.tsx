...
import {
    ...
    Bookmark, Target, Link as LinkIcon, Layers,
    AlertTriangle
} from 'lucide-react';
            ...
            {isExpanded && (
                <div className="p-4 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="space-y-1">
                                ...
                                {Array.isArray(task.secondary_keywords) && task.secondary_keywords.length > 0 && (
                                    <div className="flex items-start gap-2">
                    ...
                    <div className="space-y-4">
                        ...
                        {Array.isArray(task.competitors) && task.competitors.length > 0 && (
                            <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {Array.isArray(task.schema_type) && task.schema_type.length > 0 && (
                                <Field label="Schema Type" value={task.schema_type.join(", ")} />
                            )}
                            {Array.isArray(task.serp_feature_target) && task.serp_feature_target.length > 0 && (
                                <Field label="SERP Target" value={task.serp_feature_target.join(", ")} />
                            )}
                        </div>

                        {Array.isArray(task.internal_links) && task.internal_links.length > 0 && (
                                ...
                                <div key={month} className="border border-gray-200 rounded-xl shadow-lg bg-gray-50/50 overflow-hidden">
                                    ...
                                    {expandedMonths[month] && (
                                        <div className="p-4 sm:p-6 space-y-2">
                                            {(Array.isArray(plans[month]) ? plans[month] : []).map((task) => (
