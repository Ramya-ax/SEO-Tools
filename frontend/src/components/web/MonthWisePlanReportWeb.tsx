...
const MonthWisePlanReportWeb: React.FC<MonthWisePlanReportWebProps> = ({ data }) => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 font-sans">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Month-wise SEO Strategy Plan</h1>
